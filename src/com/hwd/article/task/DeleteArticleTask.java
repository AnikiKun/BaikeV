...
public class DeleteArticleTask extends BaseTask{
	...
	public DeleteArticleTask(ArticleDetailActivity act, long id) {
		super(act);
		this.id = id;
	}
	...
	protected void doInBackground() {
			try {
				...
				String urlStr = SERVER+"3fe71f4c982509ecec3c33_delete";
